...
const messages = {
  ja: {
    ...
    sequence: {
      ...
      motionMin: 'Min', motionMax: 'Max', motionCycles: '周期', motionPatterns: { linearUp: 'Linear Up', linearDown: 'Linear Down', sine: 'Sine', triangle: 'Triangle', square: 'Square', random: 'Random' },
