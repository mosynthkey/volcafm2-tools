...
const messages = {
  ja: {
    ...
    sequence: {
      program: 'Program No.', programNameUnknown: '音色名を取得していません', getCurrentProgram: '取得',
      ...
      captureButton: '受信', captureTitle: 'Sequenceを受信', captureDescription: 'volca fm2の現在のSequenceを1周再生し、MIDIノートを16ステップとして取り込みます。',
      captureNotesOnly: 'ノートのみ取得できます。Motionは取り込めないため、現在のMotionは失われます。',
