...
const messages = {
  ja: {
    ...
    sequence: {
      ...
      motion: 'Motion',
      motionParam: 'Parameter', motionTarget: 'Target', motionEnable: 'このパラメータを有効にする', library: 'ライブラリ',
      autoMotion: 'オートライト', writeMotion: '波形を選ぶ',
      ...
      motionMin: 'Min', motionMax: 'Max', motionCycles: 'Cycles', motionPatterns: { linearUp: 'Linear Up', linearDown: 'Linear Down', sine: 'Sine', triangle: 'Triangle', square: 'Square', random: 'Random' },
