...
const messages = {
  ja: {
    ...
    sequence: {
      ...
      stepInput: 'ステップ入力', stepInputExit: 'ステップ入力を終了', stepIndicator: 'ステップ {count}/16', stepAria: 'ステップ {count}', stepCopyHint: 'ドラッグして別のステップへコピー', stepPrev: '前のステップへ', stepNext: '次のステップへ（無音のまま進む）', stepReset: '先頭に戻す',
