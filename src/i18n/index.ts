...
const messages = {
  ja: {
    ...
    app: {
      ...
      showLog: 'ログを表示', tools: 'ツール', about: 'このアプリについて',
    ...
    sequence: {
      ...
      importSmf: 'SMFインポート', importSettings: 'SMFインポート', importBar: '開始小節', import: 'インポート', importOk: 'SMFから{count}音をインポートしました。（全{total}小節）', importError: 'インポート失敗',
    ...
    sound: {
      ...
      operator: 'Operator {count}', frequencyOutput: 'Frequency & Output', mode: 'Mode', oscillatorMode: 'Oscillator mode', ratio: 'Ratio', fixed: 'Fixed', coarse: 'Coarse', fine: 'Fine', detune: 'Detune', outputLevel: 'Output Level', ampModSens: 'Amp Mod Sens', keyVelocity: 'Key Velocity', rateScaling: 'Rate Scaling',
  ...
  en: {
    ...
    app: {
      description: 'DX7 SysEx conversion and volca fm2 sequence editing in one workspace.', showLog: 'Show log', tools: 'Tools', about: 'About', expandSidebar: 'Expand sidebar', collapseSidebar: 'Collapse sidebar',
