...
const messages = {
  ja: {
    ...
    app: {
      ...
      language: '言語',
      nav: { soundLabel: 'サウンド', sequenceLabel: 'シーケンス', dx7Label: 'サウンドリスト', sound: '音色を編集', sequence: 'シーケンスを編集', dx7: '音色を管理' },
    ...
    sound: {
      title: 'サウンド編集', sectionLabel: 'Sound', connectionError: 'volca fm2とのMIDI IN/OUT接続を確認してください。', selectAlgorithm: 'Select Algorithm', library: '音色ライブラリ', untitled: '無題',
      voiceName: '音色名', programNo: 'Program No.', getCurrent: '取得', initialize: '初期化', algorithm: 'Algorithm', modulator: 'Modulator', feedback: 'Feedback', carrierOutput: 'Carrier / Output',
    ...
    dx7: {
      ...
      listDescription: '64 個の Program です。行をクリックすると Sound で開きます。Sound ページの編集は選択中の Program に反映されます。並び替えたら書き込みで本体へ送ります。',
      ...
      importVoicesDescription: '取り込む Voice を選び、書き込み先の先頭 Program No. を指定します。選択した Voice はその番号から順にローカル一覧へ上書きします（63 の次は 0 に戻ります）。本体へは送信しません。',
    ...
    library: {
      title: 'ライブラリ', name: '名前', empty: 'まだ保存されたデータはありません。',
      ...
      kinds: { sound: 'Sound', soundList: 'Sound list', sequence: 'Sequence', bundle: 'Bundle' },
    ...
    hint: {
      title: 'Hint',
      sound: 'このページでは現在選択されている音色を編集します。\n\n音色は自動的に取得されますが、volca fm2の方を操作して音色を変えたときは取得ボタンで更新してください。\n\n編集後はvolca fm2の方で保存してください。',
  ...
  en: {
    ...
    app: {
      ...
      language: 'Language',
      nav: { soundLabel: 'Sound', sequenceLabel: 'Sequence', dx7Label: 'Sound list', sound: 'Edit the current voice', sequence: 'Edit the sequence', dx7: 'Manage voices' },
    ...
    dx7: {
      ...
      listDescription: 'These are the 64 Programs. Click a row to open it in Sound. Sound page edits apply to the selected Program. Reorder locally, then Write to send them to the hardware.',
      ...
      importVoicesTitle: 'DX7 Import',
      importVoicesDescription: 'Choose which Voices to import and the starting Program No. Selected Voices overwrite the local list in order from that number (wrapping from 63 to 0). Nothing is sent to the hardware.',
    ...
    library: {
      title: 'Library', name: 'Name', empty: 'No saved data yet.',
    ...
    hint: {
      title: 'Hint',
      sound: 'This page edits the currently selected voice.\n\nThe voice is received automatically, but if you change it on the volca fm2, press Get to update.\n\nAfter editing, save it on the volca fm2.',
