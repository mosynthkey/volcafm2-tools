...
const messages = {
  ja: {
    ...
    app: {
      showLog: 'ログを表示', log: 'ログ', tools: 'ツール', about: 'volca fm2 tools', version: 'バージョン {version}', license: 'MIT ライセンス', copyright: 'Copyright (C) 2026 Masaki Ono / Melissa Audio',
      ...
      connection: {
        ...
        step2: 'Chromeブラウザから本アプリを開いてください。',
        step2Desktop: 'デスクトップアプリから本アプリを開いてください。',
        step3: 'MIDI接続の許可ダイアログが表示された場合は、許可を選択してください。',
        reconnect: 'Reconnect',
    ...
    sequence: {
      ...
      randomizeMore: 'ほかの並べ替え', randomizeNotes: 'ノートだけランダマイズ', randomizeMotion: 'Motion だけランダマイズ', reverseSequence: 'シーケンスを逆にする',
    ...
    sound: {
      ...
      lfoSpeedUtility: 'BPMと音符からSpeedを計算', lfoSpeedUtilityTitle: 'Speed from BPM',
      ...
      lfoSpeedUtilityApply: 'Speedに入れる', lfoSpeedUtilityPeriod: '{seconds} s', lfoSpeedUtilityHz: '{hz} Hz',
      lfoSpeedUtilityNearest: 'いちばん近いSpeed', lfoSpeedUtilityAlready: 'いまのSpeedと同じです',
      lfoSpeedUtilityTooSlow: 'LFOの最遅（Speed 0）より遅いので0にします',
      lfoSpeedUtilityTooFast: 'LFOの最速（Speed 99）より速いので99にします',
    ...
    dx7: {
      ...
      dx7Import: 'DX7 インポート', dx7Export: 'DX7 エクスポート',
    ...
    library: {
      ...
      bundleDescription: 'Bundle は、ライブラリに保存されているすべての Program・Sound list・Sequence を JSON として書き出します。編集中の内容は含みません。読み込むと、同じ UUID の項目はスキップし、まだない項目だけをライブラリに追加します。',
      importResultTitle: 'ライブラリへ取り込み',
      importSkipPolicy: '同じ UUID の Program / Sound list / Sequence はすでにライブラリにあるためスキップします。UUID のない古いファイルは、新しい UUID を付けて追加します。',
      importResult: '{added} 件を追加し、{skipped} 件をスキップしました。',
      storageNotice: 'ライブラリはブラウザ内に保存されます。サイトデータの削除やプライベートブラウジングによって失われることがあります。',
      storageNoticeLink: 'こちら',
      storageNoticeAfter: 'からデータを一括ダウンロードできます。',
      storageNoticeLinkTitle: '保存データを1つの Bundle ファイルとしてダウンロード',
    },
    hint: {
      title: 'ヒント',
  ...
  en: {
    ...
    app: {
      showLog: 'Show log', log: 'Log', tools: 'Tools', about: 'volca fm2 tools', version: 'Version {version}', license: 'MIT License', copyright: 'Copyright (C) 2026 Masaki Ono / Melissa Audio', expandSidebar: 'Expand sidebar', collapseSidebar: 'Collapse sidebar',
      language: 'Language',
    ...
    library: {
      ...
      bundleDescription: 'A Bundle is a JSON dump of every Program, Sound list, and Sequence in the library. It does not include the current edit buffer. Loading it adds missing items and skips any that already exist with the same UUID.',
      importResultTitle: 'Library import',
      importSkipPolicy: 'Programs, Sound lists, and Sequences with a UUID that already exists in the library are skipped. Older files without a UUID get a new UUID and are always added.',
