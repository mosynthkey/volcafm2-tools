...
const messages = {
  ja: {
    common: { ok: 'OK', cancel: 'キャンセル', close: '閉じる', save: '保存', load: '読み込む', delete: '削除', back: '戻る', loading: '読み込み中…', send: '送信', more: 'その他', library: 'ライブラリ', autoSend: '自動', autoSendHint: '変更後、少し待ってからvolca fm2へ転送します', on: 'ON', off: 'OFF', clear: 'クリア', toggle: '切り替え', indexedDbOpenFailed: 'IndexedDBを開けませんでした。', indexedDbOpFailed: 'IndexedDBの操作に失敗しました。', indexedDbAborted: 'IndexedDBの操作が中断されました。' },
    app: {
      ...
      language: '言語',
      nav: { soundLabel: 'Program', sequenceLabel: 'Sequence', dx7Label: 'Program list', libraryLabel: 'ライブラリ', sound: 'Programを編集', sequence: 'Sequenceを編集', dx7: 'Programを管理', library: '保存データを管理' },
    ...
    sequence: {
      ...
      motion: 'Motion',
      motionParam: 'Parameter', motionTarget: 'Target', motionEnable: 'このパラメータを有効にする', motionClear: 'このパラメータのMotionを0にする', library: 'ライブラリ',
    ...
    sound: {
      title: 'Program編集', sectionLabel: 'Program', connectionError: 'volca fm2とのMIDI IN/OUT接続を確認してください。', selectAlgorithm: 'Algorithmを選択', library: 'Programライブラリ', untitled: '無題',
    ...
    library: {
      title: 'ライブラリ', sectionLabel: 'ライブラリ', name: '名前', empty: '保存データはまだありません。',
      ...
      bundleDescription: 'Bundleは、ライブラリに保存されているすべてのProgram、Program list、SequenceをJSONとして書き出します。編集中の内容は含みません。読み込むと、同じUUIDの項目はスキップし、ライブラリに存在しない項目だけを追加します。',
      importResultTitle: 'ライブラリに取り込み',
      importSkipPolicy: '同じUUIDのProgram、Program list、Sequenceは、すでにライブラリにあるためスキップします。UUIDのない古いファイルには新しいUUIDを付けて追加します。',
