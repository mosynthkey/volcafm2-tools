...
const messages = {
  ja: {
    common: { ok: 'OK', cancel: 'キャンセル', close: '閉じる', save: '保存', load: '読み込む', delete: '削除', back: '戻る', loading: '読み込み中…', send: '送信', more: 'その他', library: 'ライブラリ', autoSend: '自動', autoSendHint: '変更後、少し待ってからvolca fm2へ転送します', on: 'ON', off: 'OFF', clear: 'クリア', toggle: '切り替え' },
    app: {
