  ...
  ja: {
    ...
    app: {
      ...
      connection: {
        ...
        troubleshootTitle: 'MIDI トラブルシューティング',
        browser: 'ご使用のブラウザ',
        os: 'OS',
        browsers: { chrome: 'Chrome', other: 'Chrome以外' },
        oses: { windows: 'Windows', macos: 'macOS', other: 'その他' },
        useChrome: 'Chrome を使ってください。',
        windowsHelp: 'Windows では MIDI 接続に問題が出ることがあります。Microsoft の案内を確認してください。',
    ...
    sequence: {
      ...
      stepInput: 'ステップ入力', stepInputExit: 'ステップ入力を終了', stepIndicator: 'ステップ {count}/16', stepAria: 'ステップ {count}', stepCopyHint: 'ドラッグして別のステップへコピー。右クリックで Euclidian Copy&Paste', stepPrev: '前のステップへ', stepNext: '次のステップへ（無音のまま進む）', stepReset: '先頭に戻す',
      euclidCopy: 'Euclidian Copy&Paste', euclidCopyTitle: 'Euclidian Copy&Paste',
      euclidCopyDescription: '16ステップの円周上に均等にヒットを置き、ソースをその位置へペーストします。ヒット以外のステップは変えません。',
      euclidRingAria: 'Euclidian {count}/16', euclidPulses: 'Pulses', euclidRotation: 'Rotation', euclidPaste: 'Paste',
    ...
    library: {
      ...
      replaceListTitle: 'Program list を置き換える',
      ...
      bundleDescription: 'Bundle は、ライブラリに保存されているすべての Program・Program list・Sequence を JSON として書き出します。編集中の内容は含みません。読み込むと、同じ UUID の項目はスキップし、まだない項目だけをライブラリに追加します。',
      importResultTitle: 'ライブラリへ取り込み',
      importSkipPolicy: '同じ UUID の Program / Program list / Sequence はすでにライブラリにあるためスキップします。UUID のない古いファイルは、新しい UUID を付けて追加します。',
