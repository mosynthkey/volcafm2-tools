import { pack8to7, unpack7to8, SEQUENCE_DATA_SIZE } from '../utils/sequenceCodec'
...
export const createCurrentSequenceRequest = () => new Uint8Array([...prefix, 0x10, 0xf7])
export const createSequenceRequest = (sequenceNo: number) =>
    new Uint8Array([...prefix, 0x1c, sequenceNo & 0x0f, 0xf7])
...
export const createSequenceDump = (sequenceNo: number, data: Uint8Array) =>
    new Uint8Array([...prefix, 0x4c, sequenceNo & 0x0f, ...pack8to7(data), 0xf7])
...
export const isCurrentSequenceDump = (data: Uint8Array) => isVolcaMessage(data) && data[6] === 0x40
export const isSequenceDump = (data: Uint8Array) => isVolcaMessage(data) && data[6] === 0x4c
...
export const decodeCurrentSequence = (data: Uint8Array) => unpack7to8(data.slice(7, -1), SEQUENCE_DATA_SIZE)
export const decodeSequenceDump = (data: Uint8Array) => unpack7to8(data.slice(8, -1), SEQUENCE_DATA_SIZE)
